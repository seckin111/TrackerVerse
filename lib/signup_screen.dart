    ...
    return Scaffold(extendBodyBehindAppBar: true, appBar:AppBar(
      ...
      child: SingleChildScrollView(child: Padding(
          ...
          child: Column(children: <Widget>[
            ...
            reusableTextField("Enter Username", Icons.person_outline, true, _userNameTextController),
            const SizedBox(
              height: 20,
            ),
            reusableTextField("Enter Email id ", Icons.person_outline, true, _emailTextController),
            const SizedBox(
              height: 20,
            ),
